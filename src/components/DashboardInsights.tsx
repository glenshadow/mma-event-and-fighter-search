      ...
      >
        <div className="flex items-center justify-between border-b border-white/10 pb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-black text-lg tracking-tighter italic uppercase text-white">Current Divisional Champions</h3>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        >
          ...
          <div>
            ...
            <span className="text-[10px] text-white/30 font-mono">UFC 1 TO PRESENT CARD ARCS</span>
          </div>
          <div className="bg-red-600/10 p-3 rounded-xl border border-red-500/20">
